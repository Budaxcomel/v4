...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Budaxcomel/izinvps/ipuk/ip | grep $MYIP | awk '{print $2}')
#username=$(curl https://abc.xcodehoster.com/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
valid=$(curl https://raw.githubusercontent.com/Budaxcomel/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/Budaxcomel/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
